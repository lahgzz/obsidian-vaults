...
source: "https://obsidian.md/help/sync-notes"
author:
published:
created: 2026-07-02
...
We also recommend reading our [backup guide](https://obsidian.md/help/backup) to protect your data.

## Syncing methods

With Obsidian your data is simply stored as files in a folder called a [vault](https://obsidian.md/help/sync/vault-types). This means there are many ways to sync your data.
...
The most straightforward and officially supported sync method is our first-party solution: [Obsidian Sync](https://obsidian.md/help/sync).
...
Follow the [setup guide](https://obsidian.md/help/sync/setup) to configure Obsidian Sync.
...
- **Open the vault on another Apple device**:
	- On another macOS or iOS device, open **Obsidian**, go to the [Vault switcher](https://obsidian.md/help/manage-vaults), and select **Open folder as vault**. Navigate to **iCloud Drive → Obsidian**.
...
> 
> ![iCloud-folder-location.png > interface](https://publish-01.obsidian.md/access/f786db9fac45774fa4f0d8112e232d67/Attachments/iCloud-folder-location.png)
> 
...
3. **Open the vault on another device**:
	- On another device, open **Obsidian**, go to the [Vault switcher](https://obsidian.md/help/manage-vaults), and select **Open folder as vault**. Navigate to **OneDrive → Documents**.
...
3. **Open the vault on another device**:
	- On another device, open **Obsidian**, go to the [Vault switcher](https://obsidian.md/help/manage-vaults), and select **Open folder as vault**. Navigate to your Google Drive folder.

> [!tip] Best practices
> - Set vault files to **Available Offline** in Google Drive to avoid syncing issues due to offloading.
> - For iOS, consider alternative methods like [Obsidian Sync](https://obsidian.md/help/sync), [iCloud](https://obsidian.md/help/sync-notes#iCloud), or use the **Remotely Save** plugin.
...
3. **Open the vault in Obsidian**:
	- Once the folder is synced across devices, open **Obsidian**, go to the [Vault switcher](https://obsidian.md/help/manage-vaults), and select **Open folder as vault**.
...
Obsidian allows you to customize the configuration folder per device using the [Config folders](https://obsidian.md/help/configuration-folder) feature.